...
public class CameraSourcePreview extends ViewGroup {
    ...
    private class SurfaceCallback implements SurfaceHolder.Callback {
        ...
        public CameraSourcePreview Parent;
        ...
        public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
            if(Parent.cameraSource == null){
                return;
            }

            float previewSizeRatio = 0;
            previewSizeRatio = (float)Parent.cameraSource.getPreviewSize().getHeight() / (float)Parent.cameraSource.getPreviewSize().getWidth();

            float surfaceViewRatio = (float)Parent.surfaceView.getWidth() / (float)Parent.surfaceView.getHeight();
            float scaleX;
            float scaleY;
            ...
            Parent.surfaceView.setScaleX(scaleX);
            Parent.surfaceView.setScaleY(scaleY);
